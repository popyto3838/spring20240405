...
public class Controller20 {
    ...
    @RequestMapping("sub9")
    public void sub9(MyBean202 data) {
        //todo: sub9.jsp 만들고
        //form 요소 작성
        //city,address,title,content의 요청 파라미터 입력받고 전송
        System.out.println(data);
    }

    // /main20/sub10 요청경로에서 일하는 메소드 작성
    // city, address, title, content 의 요청 파라미터가
    // MyBean202 객체의 propterty로 바인딩 되도록 코드 작성
    ...
    public void sub12(String type,
                      String content,
                      String city) {
        System.out.println("type=" + type + " content=" + content + " city=" + city);
    }
    ...
    // todo: sub11.jsp에 form요소 작성
    // submit 클릭시 /main20/sub15로 전송
    // type, phone, book 요청 파라미터 전송
    // type : select&option 요소

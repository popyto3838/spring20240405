...
//                        "age", 15));
    ...
    public void method2(Model model) {
        model.addAttribute("age", 3);   // 어린이용 컨텐츠
        // model.addAttribute("age", 13);                       // 청소년용 컨텐츠
        // model.addAttribute("age", 23);                        // 성인용
        //  model.addAttribute("age", 33);                        // 성인용
    }
    ...
    public void method7(Model model) {
        ...
        MyBean122 e3 = new MyBean122("오타니", "LA", "일본", "야구", List.of("투수", "치명타자"));
